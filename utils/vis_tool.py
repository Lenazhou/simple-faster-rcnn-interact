...
def vis_bbox(img, bbox, label=None, score=None, ax=None):
    ...
    label_names = list(UT_BBOX_LABEL_NAMES) + ['bg']
    # add for index `-1`
    ...
    for i, bb in enumerate(bbox):
        ...
        ax.add_patch(plot.arrow(bb[4]+bb[1],bb[0],0,height,ec='green'))
        caption = list()
...
def fig4vis(fig):
    ...
    #path='/home/zhenghua/zj/simple-faster-rcnn-interact_person (copy)/test_img6/'+str(name)+'.jpg'
    ax = fig.get_figure()
